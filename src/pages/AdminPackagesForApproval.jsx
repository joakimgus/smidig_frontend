    ...
    return(
        <div className={'admin-packages-approval-container'}>
            <div className={"admin-packages-approval-top-text-container"}>
                ...
                <p>
                    Her vil du finne en oversikt over alle pakkeløsninger som venter på godkjenning.
                    Pakkeløsningene vil ikke kunne bestilles før de har blitt gjennomgått og godkjent.
                </p>
            </div>
                ...
                <>
                    <div className="admin-packages-approval-wrap">
                        ...
                        <div className="admin-package-approval-edit-column">
                            <p
                                className={"package-approve-edit-btn button"}
                            >
                                <GrFormEdit />
                            </p>
                        </div>
