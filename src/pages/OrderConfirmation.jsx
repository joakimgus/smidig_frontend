      ...
      {Object.keys(order.orderInfo).length > 0 ? (
        <div id={"order-confirmation-text"}>
          <div id={"customer-details"}>
            ...
            <label className={"column-two row-two"}>
              {order.orderInfo.contactInfo.contactPerson}
            </label>
            <label className={"column-two row-three"}>
              {order.orderInfo.contactInfo.email}
            </label>
            <label className={"column-two row-four"}>
              {order.orderInfo.contactInfo.phoneNumber}
            </label>
            <label className={"column-two row-five"}>
              {order.orderInfo.deliveryInformation.address}
            </label>
            <label className={"column-two row-six"}>
              {order.orderInfo.deliveryInformation.zipCode}
            </label>
            <label className={"column-two row-seven"}>
              {order.orderInfo.deliveryInformation.city}
            </label>
          </div>
