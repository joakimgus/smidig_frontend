  ...
  return (
    <div className={"footer-container"}>
      ...
      <div className={"contact-information-container"}>
        ...
        <div className={"contact-information-item"}>mobiltminimuseum.no</div>
        <div className={"contact-information-item"}>Adresse</div>
        <div className={"contact-information-item"}>0123 Fire</div>
        <div className={"contact-information-item"}>Tlf 11 22 33 44</div>
